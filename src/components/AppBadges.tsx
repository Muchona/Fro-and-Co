    ...
    return (
        <div className={`flex flex-wrap items-center gap-4 ${className}`}>
            ...
            >
                ...
                >
                    <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.61 3,21.09 3,20.5M16.81,15.12L18.66,16.19C19.16,16.47 19.34,17.09 19.05,17.59C18.89,17.86 18.6,18.03 18.28,18.03C18.1,18.03 17.92,17.98 17.76,17.89L14.75,16.15L16.81,15.12M16.81,8.88L14.75,7.85L17.76,6.11C18.26,5.82 18.88,6 19.17,6.5C19.46,7 19.28,7.62 18.78,7.91L16.81,8.88M12.97,12L15.42,13.29L12.97,14.58V12Z" />
                    <path d="M12.97,14.58L15.42,13.29L19.05,17.59C18.89,17.86 18.6,18.03 18.28,18.03C18.1,18.03 17.92,17.98 17.76,17.89L14.75,16.15L12.97,14.58Z" opacity="0.1" />
                    <path d="M12.97,9.42L15.42,10.71L12.97,12.00V9.42Z" opacity="0.1" />
